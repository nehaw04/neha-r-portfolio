...
*This portfolio is themed as a Machine Learning Training Dashboard.*
*Neha herself is the model. You are the recruiter. This is the deployment.*
...
║ Token        ║ Hex      ║ Used For                      ║
╠══════════════╬══════════╬═══════════════════════════════╣
║ Background   ║ #0C0C14  ║ Page base · deep navy-black   ║
║ Grid Overlay ║ #7864FF  ║ 4% opacity · 48px graph paper ║
║ El. Violet   ║ #E040FB  ║ Primary accent · CTAs · bars  ║
║ Soft Purple  ║ #B97FFF  ║ Secondary · borders · labels  ║
║ Mint Green   ║ #5FFFA0  ║ Live status · success states  ║
║ Primary Text ║ #E2E0FF  ║ Body copy · purple-tint white ║
║ Muted Text   ║ #E2E0FF  ║ 38% opacity · descriptions    ║
╚══════════════╩══════════╩═══════════════════════════════╝
```

---

## 🧩 Portfolio Sections Decoded

<div align="center">

| Section | ML Metaphor | What It Shows |
|---|---|---|
...
ANIMATION REGISTRY
══════════════════════════════════════════════════════════
01 · TEXT SCRAMBLE     Characters shuffle before locking
                       in — fires on hero, nav badges,
                       and every About layer card

02 · LOSS CURVE        SVG path draws itself — realistic
                       training curve from loss 0.682 → 0.082

03 · EPOCH LOG         Lines stream in one by one like a
                       real model training in real time

04 · PARTICLE NETWORK  50 floating nodes, purple-violet,
                       connecting within 140px radius

05 · SCROLL REVEALS    translateY(32px) → 0 with
                       cubic-bezier(0.22, 1, 0.36, 1)

06 · METRIC BARS       Fill only when scrolled into view
                       1.4s ease with spring easing

07 · CARD HOVER        2px border scaleY 0→1 top→bottom
