...
const experiments = [
  {
    ...
    headline: 'Autonomous Document Intelligence with Strict Grounding',
    desc: 'A Retrieval-Augmented Generation (RAG) system that acts as an intelligent assistant for an eBook, using a LangGraph-powered state machine to strictly ground every answer in the source document — refusing to answer anything outside the provided context to prevent hallucinations.',
    metrics: [
      { label: 'Hallucination Prevention', value: 100, display: '0 Instances' },
      { label: 'Response Time', value: 95, display: '< 2 Seconds' },
      { label: 'Context Adherence', value: 100, display: '100%' },
    ],
