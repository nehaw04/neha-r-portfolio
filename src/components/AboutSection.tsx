...
const layers = [
  {
    ...
    type: 'INPUT',
    tag: 'Foundation',
    scrambleTexts: ["init(graduate='VIT', major='AI')", "load(weights='academic')"],
    title: 'Academic Foundation',
    description: 'I am an Integrated M.Tech in AI student at VIT Bhopal. I specialize in bridging the gap between sophisticated models and user-centric apps.',
    chips: ['params: M.Tech', 'batch: AI', 'dtype: VIT Bhopal'],
  },
  {
    index: 'L2',
    type: 'HIDDEN',
